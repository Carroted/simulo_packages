...
for i=1,floor_width do
    for j=1,wall_height do
        Scene:add_attachment({
            ...
            local_angle = 0,
            images = {{
                texture = require("./packages/@carroted/pylon_recon/assets/textures/wall.png"),
    ...
    Scene:add_attachment({
        ...
        size = 1 / 12,
        images = {{
            texture = require("./packages/@carroted/pylon_recon/assets/textures/floor_top.png"),
            scale = vec2(1/12, 1/12),
    ...
    for j=1,floor_height do
        Scene:add_attachment({
            ...
            local_angle = 0,
            images = {{
                texture = require("./packages/@carroted/pylon_recon/assets/textures/floor_bottom.png"),
                scale = vec2(1/12, 1/12),
                color = Color:hex(0xffffff),
            }},
        });
